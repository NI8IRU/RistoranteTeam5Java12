...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        SecondoPiatto lonzaDiMaiale = new SecondoPiatto(TipoEnum.CARNIVORO,"Lonza di maiale in agrodolce con mele e prugne", 15.5, 150.0);
        SecondoPiatto costolette = new SecondoPiatto(TipoEnum.CARNIVORO,"Costolette d’agnello panate con carciofi e pecorino", 17.63, 100.0);
        SecondoPiatto polloEMandorle = new SecondoPiatto(TipoEnum.CARNIVORO,"Pollo alle mandorle", 16.5, 125.0);
        ...
        SecondoPiatto orata = new SecondoPiatto(TipoEnum.PESCE,"Orata al cartoccio", 16.50, 450.0);
        SecondoPiatto involtiniSpada = new SecondoPiatto(TipoEnum.PESCE,"Involtini di pesce spada e melanzane", 13.50, 200.0);
        SecondoPiatto filettoCernia = new SecondoPiatto(TipoEnum.PESCE,"Filetto di cernia alla Mediterranea", 18.00, 500.0);
        ...
        SecondoPiatto lenticchie = new SecondoPiatto(TipoEnum.VEGETARIANO,"Lenticchie condite con latte di cocco", 10.00, 150.0);
        SecondoPiatto purea = new SecondoPiatto(TipoEnum.VEGETARIANO,"Crema di patate allo zafferano", 9.50, 140.0);
        SecondoPiatto verdureCotte = new SecondoPiatto(TipoEnum.VEGETARIANO,"Verdure cotte di stagione coperte con formaggio fresco", 12.00, 190.0);
